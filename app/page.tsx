    ...
    <div className="flex-1 bg-[#020f2a] text-white flex flex-col items-center justify-center px-4 py-20">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            href="/ranking"
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full border border-white/30 hover:border-white/60 text-white text-base font-bold transition-colors"
          >
            ランキングを見る
          </Link>
        </div>
